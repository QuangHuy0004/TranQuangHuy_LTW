<section class="hdl-footer pb-4">
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               ...
               <p class="pt-1">
                  Copyright@ 2024 QUANG HUY STORE là hệ thống bán sĩ và lẽ thiết bị thông minh, đặc biệt là iphone
                  mong muốn đem đến chất lượng tốt nhất cho khách hàng.
               </p>
               <p class="pt-1">
                  20 Tăng Nhơn Phú B, TP. Thủ Đức, TP. Hồ Chí Minh
               </p>
               <p class="pt-1">
                  Điện thoại: 0961931401 - Email: huyitcdct.04@gmail.com
               </p>
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
       Design by: Tran Quang Huy - 0961931401
      </div>
   </section>
</body>
